...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
  24:	7f 26                	jg     4c <main+0x4c>
  26:	eb 5d                	jmp    85 <main+0x85>
  28:	90                   	nop
  ...
  3f:	e8 86 03 00 00       	call   3ca <close>
  if(argc <= 1){
    cat(0);
    exit(0);
  }
  ...
  47:	39 5d e4             	cmp    %ebx,-0x1c(%ebp)
  4a:	74 52                	je     9e <main+0x9e>
    if((fd = open(argv[i], 0)) < 0){
  4c:	83 ec 08             	sub    $0x8,%esp
  4f:	6a 00                	push   $0x0
  51:	ff 34 9e             	pushl  (%esi,%ebx,4)
  54:	e8 89 03 00 00       	call   3e2 <open>
  ...
  65:	ff 34 9e             	pushl  (%esi,%ebx,4)
  68:	68 43 08 00 00       	push   $0x843
  6d:	6a 01                	push   $0x1
  6f:	e8 8c 04 00 00       	call   500 <printf>
      exit(0);
  74:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  7b:	e8 22 03 00 00       	call   3a2 <exit>
  80:	83 c4 10             	add    $0x10,%esp
  83:	eb ab                	jmp    30 <main+0x30>
main(int argc, char *argv[])
{
  int fd, i;
  ...
  88:	6a 00                	push   $0x0
  8a:	e8 31 00 00 00       	call   c0 <cat>
    exit(0);
  8f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  96:	e8 07 03 00 00       	call   3a2 <exit>
  ...
  a1:	6a 00                	push   $0x0
  a3:	e8 fa 02 00 00       	call   3a2 <exit>
}
  a8:	8d 65 f0             	lea    -0x10(%ebp),%esp
...
cat(int fd)
{
  ...
  d3:	53                   	push   %ebx
  d4:	68 80 0b 00 00       	push   $0xb80
  d9:	6a 01                	push   $0x1
  db:	e8 e2 02 00 00       	call   3c2 <write>
  e0:	83 c4 10             	add    $0x10,%esp
  e3:	39 c3                	cmp    %eax,%ebx
...
cat(int fd)
{
  ...
  ef:	68 80 0b 00 00       	push   $0xb80
  f4:	56                   	push   %esi
  f5:	e8 c0 02 00 00       	call   3ba <read>
 ...
 10d:	8d 76 00             	lea    0x0(%esi),%esi
{
 ...
 113:	68 20 08 00 00       	push   $0x820
 118:	6a 01                	push   $0x1
 11a:	e8 e1 03 00 00       	call   500 <printf>
      exit(0);
 11f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 126:	e8 77 02 00 00       	call   3a2 <exit>
 ...
 133:	68 32 08 00 00       	push   $0x832
 138:	6a 01                	push   $0x1
 13a:	e8 c1 03 00 00       	call   500 <printf>
    exit(0);
 ...
 14e:	5d                   	pop    %ebp
  ...
  if(n < 0){
    printf(1, "cat: read error\n");
    exit(0);
 14f:	e9 4e 02 00 00       	jmp    3a2 <exit>
...
putc(int fd, char c)
{
 ...
 618:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 61b:	b8 58 08 00 00       	mov    $0x858,%eax
