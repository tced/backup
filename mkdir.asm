...
main(int argc, char *argv[])
{
  ...
  3d:	ff 33                	pushl  (%ebx)
  3f:	e8 06 03 00 00       	call   34a <mkdir>
...
main(int argc, char *argv[])
{
  ...
  75:	52                   	push   %edx
  76:	52                   	push   %edx
  77:	68 60 07 00 00       	push   $0x760
  7c:	6a 02                	push   $0x2
  7e:	e8 bd 03 00 00       	call   440 <printf>
    exit(0);
  83:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8a:	e8 53 02 00 00       	call   2e2 <exit>
  8f:	83 c4 10             	add    $0x10,%esp
  92:	eb c9                	jmp    5d <main+0x5d>
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  9a:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 58 0a 00 00       	mov    %eax,0xa58
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 58 0a 00 00       	mov    %eax,0xa58
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6cf:	76 3f                	jbe    710 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	39 05 58 0a 00 00    	cmp    %eax,0xa58
 ...
 6f6:	e8 e5 fe ff ff       	call   5e0 <free>
  return freep;
 6fb:	8b 15 58 0a 00 00    	mov    0xa58,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 71f:	89 15 58 0a 00 00    	mov    %edx,0xa58
      return (void*)(p + 1);
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 58 0a 00 00 5c 	movl   $0xa5c,0xa58
 73d:	0a 00 00 
 740:	c7 05 5c 0a 00 00 5c 	movl   $0xa5c,0xa5c
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 5c 0a 00 00       	mov    $0xa5c,%eax
 74f:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 756:	00 00 00 
