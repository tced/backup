...
main(int argc, char *argv[])
{
  ...
  3d:	ff 33                	pushl  (%ebx)
  3f:	e8 ee 02 00 00       	call   332 <unlink>
...
free(void *ap)
{
 ...
 5e1:	a1 50 0a 00 00       	mov    0xa50,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 50 0a 00 00       	mov    %eax,0xa50
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 50 0a 00 00       	mov    %eax,0xa50
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 50 0a 00 00    	mov    0xa50,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 71f:	89 15 50 0a 00 00    	mov    %edx,0xa50
      return (void*)(p + 1);
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 50 0a 00 00 54 	movl   $0xa54,0xa50
 73d:	0a 00 00 
 740:	c7 05 54 0a 00 00 54 	movl   $0xa54,0xa54
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 54 0a 00 00       	mov    $0xa54,%eax
 74f:	c7 05 58 0a 00 00 00 	movl   $0x0,0xa58
 756:	00 00 00 
