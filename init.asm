...
main(void)
{
  ...
  23:	79 22                	jns    47 <main+0x47>
    mknod("console", 1, 1);
  25:	83 ec 04             	sub    $0x4,%esp
  28:	6a 01                	push   $0x1
  2a:	6a 01                	push   $0x1
  2c:	68 b0 07 00 00       	push   $0x7b0
  31:	e8 44 03 00 00       	call   37a <mknod>
    open("console", O_RDWR);
  36:	59                   	pop    %ecx
  37:	5b                   	pop    %ebx
  38:	6a 02                	push   $0x2
  3a:	68 b0 07 00 00       	push   $0x7b0
  3f:	e8 2e 03 00 00       	call   372 <open>
  44:	83 c4 10             	add    $0x10,%esp
  }
  dup(0);  // stdout
  47:	83 ec 0c             	sub    $0xc,%esp
  4a:	6a 00                	push   $0x0
  4c:	e8 59 03 00 00       	call   3aa <dup>
  dup(0);  // stderr
  51:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  58:	e8 4d 03 00 00       	call   3aa <dup>
  ...
  6a:	e8 21 04 00 00       	call   490 <printf>
    pid = fork();
  6f:	e8 b6 02 00 00       	call   32a <fork>
    if(pid < 0){
  ...
  79:	89 c3                	mov    %eax,%ebx
    if(pid < 0){
  7b:	78 64                	js     e1 <main+0xe1>
      printf(1, "init: fork failed\n");
      exit(0);
    }
    if(pid == 0){
  7d:	74 31                	je     b0 <main+0xb0>
  7f:	90                   	nop
      exec("sh", argv);
  ...
  83:	6a 00                	push   $0x0
  85:	e8 b0 02 00 00       	call   33a <wait>
  8a:	83 c4 10             	add    $0x10,%esp
  8d:	39 c3                	cmp    %eax,%ebx
  8f:	74 cf                	je     60 <main+0x60>
  91:	85 c0                	test   %eax,%eax
  93:	78 cb                	js     60 <main+0x60>
      printf(1, "zombie!\n");
  95:	83 ec 08             	sub    $0x8,%esp
  98:	68 f7 07 00 00       	push   $0x7f7
  9d:	6a 01                	push   $0x1
  9f:	e8 ec 03 00 00       	call   490 <printf>
  a4:	83 c4 10             	add    $0x10,%esp
  a7:	eb d7                	jmp    80 <main+0x80>
  ...
  b3:	68 a4 0a 00 00       	push   $0xaa4
  b8:	68 de 07 00 00       	push   $0x7de
  bd:	e8 a8 02 00 00       	call   36a <exec>
      printf(1, "init: exec sh failed\n");
  c2:	58                   	pop    %eax
  c3:	5a                   	pop    %edx
  c4:	68 e1 07 00 00       	push   $0x7e1
  c9:	6a 01                	push   $0x1
  cb:	e8 c0 03 00 00       	call   490 <printf>
      exit(0);
  d0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  d7:	e8 56 02 00 00       	call   332 <exit>
  dc:	83 c4 10             	add    $0x10,%esp
  df:	eb 9f                	jmp    80 <main+0x80>
  ...
  e4:	68 cb 07 00 00       	push   $0x7cb
  e9:	eb de                	jmp    c9 <main+0xc9>
  eb:	66 90                	xchg   %ax,%ax
  ed:	66 90                	xchg   %ax,%ax
  ef:	90                   	nop
