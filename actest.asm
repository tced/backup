...
_actest:     file format elf32-i386
...
pid1 = fork(); 
  19:	e8 1c 03 00 00       	call   33a <fork>

if( pid1 != 0) {
  1e:	85 c0                	test   %eax,%eax
  20:	75 21                	jne    43 <main+0x43>
		fork(); 
		printf(1, "%d\n", ++i); 
	}
exit(0); 
...
printf(1, "%d\n", ++i);  
  ...
  25:	83 c3 01             	add    $0x1,%ebx
  28:	53                   	push   %ebx
  29:	68 c0 07 00 00       	push   $0x7c0
  2e:	6a 01                	push   $0x1
  30:	e8 6b 04 00 00       	call   4a0 <printf>

}
  35:	8d 65 f0             	lea    -0x10(%ebp),%esp
...
if( pid1 != 0) {
  ...
  60:	75 2b                	jne    8d <main+0x8d>
		...
		fork(); 
  62:	e8 d3 02 00 00       	call   33a <fork>
		printf(1, "%d\n", ++i); 
  67:	50                   	push   %eax
  68:	6a 05                	push   $0x5
  6a:	bb 05 00 00 00       	mov    $0x5,%ebx
  6f:	68 c0 07 00 00       	push   $0x7c0
  74:	6a 01                	push   $0x1
  76:	e8 25 04 00 00       	call   4a0 <printf>
...
if( pid1 != 0) {
  ...
  8d:	8d 7d e4             	lea    -0x1c(%ebp),%edi
  90:	52                   	push   %edx
  91:	6a 00                	push   $0x0
  93:	57                   	push   %edi
  94:	56                   	push   %esi
  95:	e8 48 03 00 00       	call   3e2 <waitpid>
		printf(1, "Successfully exited", ret_pid, exit_status);
  9a:	ff 75 e4             	pushl  -0x1c(%ebp)
  9d:	50                   	push   %eax
  9e:	68 c4 07 00 00       	push   $0x7c4
  a3:	6a 01                	push   $0x1
  a5:	e8 f6 03 00 00       	call   4a0 <printf>
		printf(1, "%d\n", ++i); 
  aa:	83 c4 1c             	add    $0x1c,%esp
  ad:	6a 05                	push   $0x5
  af:	68 c0 07 00 00       	push   $0x7c0
  b4:	6a 01                	push   $0x1
  b6:	e8 e5 03 00 00       	call   4a0 <printf>
		ret_pid = waitpid(pid2, &exit_status, 0); 
  ...
  c2:	bb 06 00 00 00       	mov    $0x6,%ebx
	...
	if (pid2 != 0) {
		...
		printf(1, "%d\n", ++i); 
		ret_pid = waitpid(pid2, &exit_status, 0); 
  c7:	e8 16 03 00 00       	call   3e2 <waitpid>
		printf(1, "Successfully exited", ret_pid, exit_status); 
  cc:	ff 75 e4             	pushl  -0x1c(%ebp)
  cf:	50                   	push   %eax
  d0:	68 c4 07 00 00       	push   $0x7c4
  d5:	6a 01                	push   $0x1
  d7:	e8 c4 03 00 00       	call   4a0 <printf>
		printf(1, "%d\n", ++i);  
  dc:	83 c4 1c             	add    $0x1c,%esp
  df:	6a 06                	push   $0x6
  e1:	68 c0 07 00 00       	push   $0x7c0
  e6:	6a 01                	push   $0x1
  e8:	e8 b3 03 00 00       	call   4a0 <printf>
  ed:	83 c4 10             	add    $0x10,%esp
  f0:	eb 8c                	jmp    7e <main+0x7e>
  f2:	66 90                	xchg   %ax,%ax
  f4:	66 90                	xchg   %ax,%ax
  f6:	66 90                	xchg   %ax,%ax
  f8:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43f:	f7 f6                	div    %esi
 441:	0f b6 92 e0 07 00 00 	movzbl 0x7e0(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5b8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5bb:	b8 d8 07 00 00       	mov    $0x7d8,%eax
...
free(void *ap)
{
 ...
 697:	89 08                	mov    %ecx,(%eax)
  freep = p;
 699:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 69e:	5b                   	pop    %ebx
 69f:	5e                   	pop    %esi
 6a0:	5f                   	pop    %edi
 ...
 6ba:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6bd:	a3 98 0a 00 00       	mov    %eax,0xa98
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 72f:	76 3f                	jbe    770 <malloc+0xa0>
    ...
    if(p == freep)
 731:	39 05 98 0a 00 00    	cmp    %eax,0xa98
 ...
 756:	e8 e5 fe ff ff       	call   640 <free>
  return freep;
 75b:	8b 15 98 0a 00 00    	mov    0xa98,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 79d:	0a 00 00 
 7a0:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	b8 9c 0a 00 00       	mov    $0xa9c,%eax
