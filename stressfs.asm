...
main(int argc, char *argv[])
{
  ...
  65:	0f 8f db 00 00 00    	jg     146 <main+0x146>
  char data[512];
...
//    printf(fd, "%d\n", i);
 ...
 127:	e8 6e 02 00 00       	call   39a <wait>

  exit(0);
 12c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 133:	e8 5a 02 00 00       	call   392 <exit>
}
 138:	8d 65 f0             	lea    -0x10(%ebp),%esp
 ...
 140:	5f                   	pop    %edi
 141:	5d                   	pop    %ebp
 142:	8d 61 fc             	lea    -0x4(%ecx),%esp
 145:	c3                   	ret    
 146:	89 df                	mov    %ebx,%edi
 148:	e9 2b ff ff ff       	jmp    78 <main+0x78>
...
free(void *ap)
{
 ...
 6e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6e9:	a3 f8 0a 00 00       	mov    %eax,0xaf8
}
 6ee:	5b                   	pop    %ebx
 6ef:	5e                   	pop    %esi
 6f0:	5f                   	pop    %edi
 ...
 70a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 70d:	a3 f8 0a 00 00       	mov    %eax,0xaf8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 f8 0a 00 00    	mov    0xaf8,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 77f:	76 3f                	jbe    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	39 05 f8 0a 00 00    	cmp    %eax,0xaf8
 ...
 7a6:	e8 e5 fe ff ff       	call   690 <free>
  return freep;
 7ab:	8b 15 f8 0a 00 00    	mov    0xaf8,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7cf:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
      return (void*)(p + 1);
 ...
 7e4:	eb e9                	jmp    7cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7e6:	c7 05 f8 0a 00 00 fc 	movl   $0xafc,0xaf8
 7ed:	0a 00 00 
 7f0:	c7 05 fc 0a 00 00 fc 	movl   $0xafc,0xafc
 7f7:	0a 00 00 
    base.s.size = 0;
 7fa:	b8 fc 0a 00 00       	mov    $0xafc,%eax
 7ff:	c7 05 00 0b 00 00 00 	movl   $0x0,0xb00
 806:	00 00 00 
