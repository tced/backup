...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
  15:	74 1d                	je     34 <main+0x34>
    printf(2, "Usage: ln old new\n");
  17:	50                   	push   %eax
  18:	50                   	push   %eax
  19:	68 40 07 00 00       	push   $0x740
  1e:	6a 02                	push   $0x2
  ...
  37:	ff 73 08             	pushl  0x8(%ebx)
  3a:	ff 73 04             	pushl  0x4(%ebx)
  3d:	e8 e0 02 00 00       	call   322 <link>
  ...
  4c:	6a 00                	push   $0x0
  4e:	e8 6f 02 00 00       	call   2c2 <exit>
}
  ...
  if(link(argv[1], argv[2]) < 0)
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  5f:	ff 73 08             	pushl  0x8(%ebx)
  62:	ff 73 04             	pushl  0x4(%ebx)
  65:	68 53 07 00 00       	push   $0x753
  6a:	6a 02                	push   $0x2
  6c:	e8 af 03 00 00       	call   420 <printf>
  71:	83 c4 10             	add    $0x10,%esp
  74:	eb d3                	jmp    49 <main+0x49>
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax
  7c:	66 90                	xchg   %ax,%ax
